...
setup(
    ...
    use_scm_version={
        ...
        'write_to': 'pestle/_version.py',
        'fallback_version': '0.0.0',
    },
    description='SigTools in Python',
    author='Anup Jonchhe',
    author_email='APJonchhe@gmail.com',
    url='https://github.com/csci-e-29/2020sp-pset-5-NoopDawg',
